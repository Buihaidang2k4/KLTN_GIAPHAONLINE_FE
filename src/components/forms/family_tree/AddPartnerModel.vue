...
import { X, Camera, Trash2, User, Phone, MapPin, BookOpen, Calendar, ChevronDown, AlertCircle, Heart } from 'lucide-vue-next';
...
const { values, errors, defineField, handleSubmit, resetForm, setValues } = useForm({
    ...
    initialValues: {
        fullName: "",
        gender: props.member?.gender === "MALE" ? "FEMALE" : "MALE",
        lifeStatus: "ALIVE",
        birthOrder: 1,
        biography: "",
        birthDate: "",
                ...
                <div class="overflow-y-auto custom-scrollbar flex-1">
                    <div class="px-10 py-10">
                        ...
                        <div class="mt-12 flex items-center justify-end gap-4 pt-8 border-t border-stone-100">
                            ...
                            <button @click="onSave"
                                class="px-10 py-3.5 rounded-2xl font-bold text-white bg-rose-600 hover:bg-rose-500 shadow-xl shadow-rose-900/20 transition-all active:scale-[0.98] uppercase text-[10px] tracking-[0.2em] flex items-center gap-3 group">
                                <span>Thêm kết duyên</span>
                                <Heart :size="14" class="fill-white group-hover:scale-125 transition-transform" />
                            </button>
                        </div>
                    </div>
                </div>
