    ...
    <Transition name="fade">
        <div v-if="isOpen" class="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div
                ...
                <!-- Header trang trí -->
                <div class="h-2 bg-gradient-to-r from-blue-800 via-blue-500 to-blue-800 flex-shrink-0"></div>
                ...
                <div class="overflow-y-auto custom-scrollbar flex-1">
                    <div class="px-10 py-10">
                        ...
                        <div class="text-center mb-12">
                            <span
                                class="text-[10px] font-bold text-blue-800 tracking-[0.5em] uppercase opacity-50 block mb-2">Khởi
                                nguồn dòng tộc</span>
                            <h2 class="text-3xl font-bold text-stone-800 font-serif italic">Khai Báo Cụ Đời Đầu</h2>
                            <div class="flex justify-center mt-4">
                                <div class="h-0.5 w-20 bg-blue-100 rounded-full relative">
                                    <div
                                        class="absolute inset-y-0 left-1/2 -translate-x-1/2 w-8 bg-blue-800 rounded-full">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col lg:flex-row gap-12">
                            ...
                            <div class="flex flex-col items-center flex-shrink-0 lg:w-48 pt-2">
                                <div class="relative group">
                                    <div
                                        class="absolute inset-0 bg-blue-500 rounded-full blur-2xl opacity-10 group-hover:opacity-20 transition-opacity">
                                    </div>
                                        ...
                                        <div class="space-y-1">
                                            <div class="relative">
                                                ...
                                                <input v-model="fullName" type="text"
                                                    ...
                                                    :class="['w-full pl-11 pr-5 py-3 bg-stone-50 border rounded-2xl focus:ring-4 focus:ring-blue-900/5 focus:border-blue-800 outline-none transition-all text-sm font-medium', errors.fullName ? 'border-red-300 bg-red-50/30' : 'border-stone-100']" />
                                            </div>
                                    ...
                                    <div class="grid grid-cols-[150px_1fr] gap-6 items-center">
                                        ...
                                        <div class="relative">
                                            <select v-model="gender"
                                                class="w-full px-5 py-3 bg-stone-50 border border-stone-100 rounded-2xl focus:ring-4 focus:ring-blue-900/5 focus:border-blue-800 outline-none transition-all text-stone-800 text-sm font-medium appearance-none cursor-pointer">
                                    ...
                                    <div class="grid grid-cols-[150px_1fr] gap-6 items-start pt-4">
                                        ...
                                        <div class="relative">
                                            ...
                                            <textarea v-model="biography" rows="3"
                                                ...
                                                class="w-full pl-11 pr-5 py-4 bg-stone-50 border border-stone-100 rounded-[1.5rem] focus:ring-4 focus:ring-blue-900/5 focus:border-blue-800 outline-none transition-all text-sm font-medium text-stone-800 resize-none"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mt-12 flex items-center justify-end gap-4 pt-8 border-t border-stone-100">
                            ...
                            <button @click="onSave"
                                class="px-10 py-3.5 rounded-2xl font-bold text-white bg-blue-800 hover:bg-blue-700 shadow-xl shadow-blue-900/20 transition-all active:scale-[0.98] uppercase text-[10px] tracking-[0.2em] flex items-center gap-3 group">
                                <span>Thêm đời đầu </span>
